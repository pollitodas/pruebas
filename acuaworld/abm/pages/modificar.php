...
if (isset($_GET['id'])) {
	echo $_GET['id'];
	$idAmodficiacar = $_GET['id'];


	$query = "Select * from product where id_prod =".$idAmodficiacar;
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="modificar.php"><i class="fa fa-link"></i> <span>modificar producto</span></a></li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
    	<div align=center>
		    <form enctype="multipart/form-data" method='POST' action='../procesadorDatos.php?proceso=modificar'>
				<br />
				<br />
				<strong>Nombre del Prodcuto</strong>
				<br />
				<br />
				<input type='text' maxlength='22' id='nombre' name='nombre' size='50' value="<?php echo $row['name']?>">
				<br />
				<br />
				<strong>Precio del Prodcuto</strong>
				<br />
				<br />
				<input type='text' maxlength='22' id='precio' name='precio' size='50'  value="<?php echo $row['price_unit']?>">
				<br />
				<br />
				<strong>Descripcion del Prodcuto</strong>
				<br />
				<br />
				<input type='text' maxlength='22' id='desc' name='desc' size='50'  value="<?php echo $row['desc']?>"> 
				<br />s
				<br />
